# README banner — profile/assets/org-banner-v3.jpg

Asset: `profile/assets/org-banner-v3.jpg` (1408x469, 3:1)
...
```text
A von Karman vortex street rendered in exquisitely fine streaklines. A calm, clean, perfectly ordered laminar sheet of hairline streaklines flows in from the LEFT and rolls up into two neat staggered rows of alternating-sign vortices, the upper row fine cyan and teal, the lower row picked out in hot coral. The street stays highly regular, periodic and crisply ordered across MOST of the width. ONLY in the last fifth, at the extreme right edge, does it lose coherence and diffuse into fine turbulent filaments.
```
